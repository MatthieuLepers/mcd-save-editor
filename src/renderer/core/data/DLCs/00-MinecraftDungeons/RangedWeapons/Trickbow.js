export default {
  Trickbow: {
    ...
    type: 'Ranged',
    rarity: ['Common', 'Rare'],
    image: 'img/Items/RangedWeapons/Trickbow.png',
    ancientHuntRunes: ['r'],
  ...
  Trickbow_Unique1: {
    ...
    type: 'Ranged',
    rarity: ['Unique'],
    image: 'img/Items/RangedWeapons/TheGreenMenace.png',
  ...
  Trickbow_Unique2: {
    ...
    type: 'Ranged',
    rarity: ['Unique'],
    image: 'img/Items/RangedWeapons/ThePinkScoundrel.png',
  ...
  Trickbow_Year1: {
    ...
    type: 'Ranged',
    rarity: ['Unique'],
    image: 'img/Items/RangedWeapons/SugarRush.png',
    ancientHuntRunes: ['r', 'i'],
    stats: { power: 1.87, speed: 3.41, ammo: 5.33 },
