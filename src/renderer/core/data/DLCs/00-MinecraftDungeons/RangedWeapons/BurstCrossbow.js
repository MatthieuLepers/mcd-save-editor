export default {
  BurstCrossbow: {
    ...
    type: 'Ranged',
    rarity: ['Common', 'Rare'],
    image: 'img/Items/RangedWeapons/BurstCrossbow.png',
  ...
  BurstCrossbow_Unique1: {
    ...
    type: 'Ranged',
    rarity: ['Unique'],
    image: 'img/Items/RangedWeapons/SoulHunterCrossbow.png',
  ...
  BurstCrossbow_Unique2: {
    ...
    type: 'Ranged',
    rarity: ['Unique'],
    image: 'img/Items/RangedWeapons/CorruptedCrossbow.png',
