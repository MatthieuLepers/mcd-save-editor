export default {
  ExplodingCrossbow: {
    ...
    type: 'Ranged',
    rarity: ['Common', 'Rare'],
    image: 'img/Items/RangedWeapons/ExplodingCrossbow.png',
    ancientHuntRunes: ['i'],
  ...
  ExplodingCrossbow_Unique1: {
    ...
    type: 'Ranged',
    rarity: ['Unique'],
    image: 'img/Items/RangedWeapons/ImplodingCrossbow.png',
  ...
  ExplodingCrossbow_Unique2: {
    ...
    type: 'Ranged',
    rarity: ['Unique'],
    image: 'img/Items/RangedWeapons/FireboltThrower.png',
    ancientHuntRunes: ['i'],
    stats: { power: 12.27, speed: 1, ammo: 1 },
