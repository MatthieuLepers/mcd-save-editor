export default {
  WolfArmor: {
    ...
    type: 'Armor',
    rarity: ['Common', 'Rare'],
    image: 'img/Items/Armors/WolfArmor.png',
  ...
  WolfArmor_Unique1: {
    ...
    type: 'Armor',
    rarity: ['Unique'],
    image: 'img/Items/Armors/FoxArmor.png',
  ...
  WolfArmor_Unique2: {
    ...
    type: 'Armor',
    rarity: ['Unique'],
    image: 'img/Items/Armors/NightWolfArmor.png',
  ...
  WolfArmor_Winter1: {
    ...
    type: 'Armor',
    rarity: ['Unique'],
    image: 'img/Items/Armors/ArcticFoxArmor.png',
